...
from packages.channelnorm_package.channelnorm import ChannelNorm
...
class FlowNet2(nn.Module):
    ...
    def forward(self, img1, img2):
        # print(torch.mean(img1[0][0]).cpu().numpy())
        # print(img1[0][0].cpu().numpy())
        # print(img1.type())
        ### normaize input
        sz = img1.size()
        ...
        # print(torch.mean(img1).cpu().numpy())
        # flownetc
